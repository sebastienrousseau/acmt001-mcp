.PHONY: help install dev test lint format type-check security clean examples doc-coverage docs check
...
clean: ## Remove build artifacts and caches
	rm -rf build/ dist/ *.egg-info .eggs/ docs/_build/ .hypothesis/
