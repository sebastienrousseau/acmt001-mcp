...
"""Check the published acmt001 suite agrees with its own policy.
...
* **A member left behind.** The acmt001 packages carried 0.0.5, 0.0.2 and 0.0.8 at the same
...
#: Every published member of the acmt001 suite. The core is first.
MEMBERS = (
    "acmt001",
    "acmt001-lsp",
    "acmt001-mcp",
