...
# first call on a message type compiles its JSON Schema, which is a
# cold-start cost, not a property of the handler. Under mutmut they use
# a slimmer profile: each mutant re-runs the whole selection, so twenty
